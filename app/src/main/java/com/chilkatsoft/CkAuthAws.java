...
public class CkAuthAws {
  ...
  public boolean GenPresignedUrl(String httpVerb, boolean useHttps, String domain, String path, int numSecondsValid, String awsService, CkString outStr) {
    return chilkatJNI.CkAuthAws_GenPresignedUrl(swigCPtr, this, httpVerb, useHttps, domain, path, numSecondsValid, awsService, CkString.getCPtr(outStr), outStr);
  }

  public String genPresignedUrl(String httpVerb, boolean useHttps, String domain, String path, int numSecondsValid, String awsService) {
    return chilkatJNI.CkAuthAws_genPresignedUrl(swigCPtr, this, httpVerb, useHttps, domain, path, numSecondsValid, awsService);
  }
