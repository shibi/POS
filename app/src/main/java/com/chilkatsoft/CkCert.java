...
public class CkCert {
  ...
  public void get_ExtendedKeyUsage(CkString str) {
    chilkatJNI.CkCert_get_ExtendedKeyUsage(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String extendedKeyUsage() {
    return chilkatJNI.CkCert_extendedKeyUsage(swigCPtr, this);
  }
  ...
  public void get_SubjectAlternativeName(CkString str) {
    chilkatJNI.CkCert_get_SubjectAlternativeName(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String subjectAlternativeName() {
    return chilkatJNI.CkCert_subjectAlternativeName(swigCPtr, this);
  }
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkCert_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkCert_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkCert_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public boolean GetExtensionAsText(String oid, CkString outStr) {
    return chilkatJNI.CkCert_GetExtensionAsText(swigCPtr, this, oid, CkString.getCPtr(outStr), outStr);
  }

  public String getExtensionAsText(String oid) {
    return chilkatJNI.CkCert_getExtensionAsText(swigCPtr, this, oid);
  }

  public String extensionAsText(String oid) {
    return chilkatJNI.CkCert_extensionAsText(swigCPtr, this, oid);
  }
  ...
  public boolean GetPubKeyDer(boolean preferPkcs1, CkBinData bd) {
    return chilkatJNI.CkCert_GetPubKeyDer(swigCPtr, this, preferPkcs1, CkBinData.getCPtr(bd), bd);
  }

  public boolean GetSignature(CkBinData bd) {
    return chilkatJNI.CkCert_GetSignature(swigCPtr, this, CkBinData.getCPtr(bd), bd);
  }
  ...
  public boolean GetSubjectPart(String partNameOrOid, CkString outStr) {
    return chilkatJNI.CkCert_GetSubjectPart(swigCPtr, this, partNameOrOid, CkString.getCPtr(outStr), outStr);
  }

  public String getSubjectPart(String partNameOrOid) {
    return chilkatJNI.CkCert_getSubjectPart(swigCPtr, this, partNameOrOid);
  }

  public String subjectPart(String partNameOrOid) {
    return chilkatJNI.CkCert_subjectPart(swigCPtr, this, partNameOrOid);
  }
  ...
  public boolean LoadBySubjectOid(String oid, String value) {
    return chilkatJNI.CkCert_LoadBySubjectOid(swigCPtr, this, oid, value);
  }

  public boolean LoadByThumbprint(String thumbprint, String encoding) {
    return chilkatJNI.CkCert_LoadByThumbprint(swigCPtr, this, thumbprint, encoding);
  }
