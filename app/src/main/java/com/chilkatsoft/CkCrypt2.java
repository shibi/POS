...
public class CkCrypt2 {
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkCrypt2_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkCrypt2_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkCrypt2_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public boolean AddSigningCert(CkCert cert) {
    return chilkatJNI.CkCrypt2_AddSigningCert(swigCPtr, this, CkCert.getCPtr(cert), cert);
  }
  ...
  public void ClearSigningCerts() {
    chilkatJNI.CkCrypt2_ClearSigningCerts(swigCPtr, this);
  }
  ...
  public boolean CoSign(CkBinData bdIn, CkCert cert, CkBinData bdOut) {
    return chilkatJNI.CkCrypt2_CoSign(swigCPtr, this, CkBinData.getCPtr(bdIn), bdIn, CkCert.getCPtr(cert), cert, CkBinData.getCPtr(bdOut), bdOut);
  }
  ...
  public boolean SignHashENC(String encodedHash, String hashAlg, String hashEncoding, CkString outStr) {
    return chilkatJNI.CkCrypt2_SignHashENC(swigCPtr, this, encodedHash, hashAlg, hashEncoding, CkString.getCPtr(outStr), outStr);
  }

  public String signHashENC(String encodedHash, String hashAlg, String hashEncoding) {
    return chilkatJNI.CkCrypt2_signHashENC(swigCPtr, this, encodedHash, hashAlg, hashEncoding);
  }

  public CkTask SignHashENCAsync(String encodedHash, String hashAlg, String hashEncoding) {
    long cPtr = chilkatJNI.CkCrypt2_SignHashENCAsync(swigCPtr, this, encodedHash, hashAlg, hashEncoding);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public void XtsSetDataUnitNumber(long loUint32, long hiUint32) {
    chilkatJNI.CkCrypt2_XtsSetDataUnitNumber(swigCPtr, this, loUint32, hiUint32);
  }

  public void XtsSetEncodedTweakKey(String key, String encoding) {
    chilkatJNI.CkCrypt2_XtsSetEncodedTweakKey(swigCPtr, this, key, encoding);
  }

  public void XtsSetEncodedTweakValue(String tweak, String encoding) {
    chilkatJNI.CkCrypt2_XtsSetEncodedTweakValue(swigCPtr, this, tweak, encoding);
  }
