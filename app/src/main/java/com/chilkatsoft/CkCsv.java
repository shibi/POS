...
public class CkCsv {
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkCsv_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkCsv_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkCsv_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public boolean InsertColumn(int index) {
    return chilkatJNI.CkCsv_InsertColumn(swigCPtr, this, index);
  }
  ...
  public boolean SaveToSb(CkStringBuilder sb) {
    return chilkatJNI.CkCsv_SaveToSb(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb);
  }
  ...
  public boolean SortByColumnIndex(int index, boolean ascending, boolean caseSensitive) {
    return chilkatJNI.CkCsv_SortByColumnIndex(swigCPtr, this, index, ascending, caseSensitive);
  }
