...
public class CkDirTree {
  ...
  public void get_FileSizeStr(CkString str) {
    chilkatJNI.CkDirTree_get_FileSizeStr(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String fileSizeStr() {
    return chilkatJNI.CkDirTree_fileSizeStr(swigCPtr, this);
  }
