...
public class CkDsa {
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkDsa_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkDsa_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkDsa_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public boolean GenKey2(int keyLenBits, int modLenBits) {
    return chilkatJNI.CkDsa_GenKey2(swigCPtr, this, keyLenBits, modLenBits);
  }
  ...
  public boolean GenKeyFromPQG(String pHex, String qHex, String gHex) {
    return chilkatJNI.CkDsa_GenKeyFromPQG(swigCPtr, this, pHex, qHex, gHex);
  }
