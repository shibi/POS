...
public class CkHashtable {
  ...
  public boolean ToQueryString(CkString outStr) {
    return chilkatJNI.CkHashtable_ToQueryString(swigCPtr, this, CkString.getCPtr(outStr), outStr);
  }

  public String toQueryString() {
    return chilkatJNI.CkHashtable_toQueryString(swigCPtr, this);
  }
