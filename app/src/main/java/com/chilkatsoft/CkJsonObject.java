...
public class CkJsonObject {
  ...
  public boolean get_LowerCaseNames() {
    return chilkatJNI.CkJsonObject_get_LowerCaseNames(swigCPtr, this);
  }

  public void put_LowerCaseNames(boolean newVal) {
    chilkatJNI.CkJsonObject_put_LowerCaseNames(swigCPtr, this, newVal);
  }
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkJsonObject_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkJsonObject_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkJsonObject_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public int DeleteRecords(String arrayPath, String relpath, String value, boolean caseSensitive) {
    return chilkatJNI.CkJsonObject_DeleteRecords(swigCPtr, this, arrayPath, relpath, value, caseSensitive);
  }
