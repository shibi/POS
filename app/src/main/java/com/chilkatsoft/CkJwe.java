...
public class CkJwe {
  ...
  public boolean GetHeader(CkJsonObject json) {
    return chilkatJNI.CkJwe_GetHeader(swigCPtr, this, CkJsonObject.getCPtr(json), json);
  }

  public boolean GetProtectedHeader(CkJsonObject json) {
    return chilkatJNI.CkJwe_GetProtectedHeader(swigCPtr, this, CkJsonObject.getCPtr(json), json);
  }
