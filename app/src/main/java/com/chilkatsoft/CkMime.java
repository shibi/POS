...
public class CkMime {
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkMime_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkMime_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkMime_put_UncommonOptions(swigCPtr, this, newVal);
  }
