...
public class CkOAuth1 {
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkOAuth1_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkOAuth1_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkOAuth1_put_UncommonOptions(swigCPtr, this, newVal);
  }
