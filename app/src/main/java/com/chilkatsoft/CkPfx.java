...
public class CkPfx {
  ...
  public void get_AlgorithmId(CkString str) {
    chilkatJNI.CkPfx_get_AlgorithmId(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String algorithmId() {
    return chilkatJNI.CkPfx_algorithmId(swigCPtr, this);
  }

  public void put_AlgorithmId(String newVal) {
    chilkatJNI.CkPfx_put_AlgorithmId(swigCPtr, this, newVal);
  }
  ...
  public void get_Pbes2CryptAlg(CkString str) {
    chilkatJNI.CkPfx_get_Pbes2CryptAlg(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String pbes2CryptAlg() {
    return chilkatJNI.CkPfx_pbes2CryptAlg(swigCPtr, this);
  }

  public void put_Pbes2CryptAlg(String newVal) {
    chilkatJNI.CkPfx_put_Pbes2CryptAlg(swigCPtr, this, newVal);
  }

  public void get_Pbes2HmacAlg(CkString str) {
    chilkatJNI.CkPfx_get_Pbes2HmacAlg(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String pbes2HmacAlg() {
    return chilkatJNI.CkPfx_pbes2HmacAlg(swigCPtr, this);
  }

  public void put_Pbes2HmacAlg(String newVal) {
    chilkatJNI.CkPfx_put_Pbes2HmacAlg(swigCPtr, this, newVal);
  }

  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkPfx_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkPfx_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkPfx_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public CkCert FindCertByLocalKeyId(String localKeyId, String encoding) {
    long cPtr = chilkatJNI.CkPfx_FindCertByLocalKeyId(swigCPtr, this, localKeyId, encoding);
  ...
  public boolean GetSafeBagAttr(boolean forPrivateKey, int index, String attrName, CkString outStr) {
    return chilkatJNI.CkPfx_GetSafeBagAttr(swigCPtr, this, forPrivateKey, index, attrName, CkString.getCPtr(outStr), outStr);
  }

  public String getSafeBagAttr(boolean forPrivateKey, int index, String attrName) {
    return chilkatJNI.CkPfx_getSafeBagAttr(swigCPtr, this, forPrivateKey, index, attrName);
  }

  public String safeBagAttr(boolean forPrivateKey, int index, String attrName) {
    return chilkatJNI.CkPfx_safeBagAttr(swigCPtr, this, forPrivateKey, index, attrName);
  }

  public CkJsonObject LastJsonData() {
    long cPtr = chilkatJNI.CkPfx_LastJsonData(swigCPtr, this);
  ...
  public boolean SetSafeBagAttr(boolean forPrivateKey, int index, String name, String value, String encoding) {
    return chilkatJNI.CkPfx_SetSafeBagAttr(swigCPtr, this, forPrivateKey, index, name, value, encoding);
  }
