...
public class CkPrivateKey {
  ...
  public boolean GetRawHex(CkStringBuilder pubKey, CkString outStr) {
    return chilkatJNI.CkPrivateKey_GetRawHex(swigCPtr, this, CkStringBuilder.getCPtr(pubKey), pubKey, CkString.getCPtr(outStr), outStr);
  }

  public String getRawHex(CkStringBuilder pubKey) {
    return chilkatJNI.CkPrivateKey_getRawHex(swigCPtr, this, CkStringBuilder.getCPtr(pubKey), pubKey);
  }

  public String rawHex(CkStringBuilder pubKey) {
    return chilkatJNI.CkPrivateKey_rawHex(swigCPtr, this, CkStringBuilder.getCPtr(pubKey), pubKey);
  }
  ...
  public boolean LoadAnyFormatFile(String path, String password) {
    return chilkatJNI.CkPrivateKey_LoadAnyFormatFile(swigCPtr, this, path, password);
  }

  public boolean LoadEd25519(String privKey, String pubKey) {
    return chilkatJNI.CkPrivateKey_LoadEd25519(swigCPtr, this, privKey, pubKey);
  }
