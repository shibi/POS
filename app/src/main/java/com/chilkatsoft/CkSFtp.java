...
public class CkSFtp {
  ...
  public int get_LastStatusCode() {
    return chilkatJNI.CkSFtp_get_LastStatusCode(swigCPtr, this);
  }

  public void get_LastStatusMessage(CkString str) {
    chilkatJNI.CkSFtp_get_LastStatusMessage(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String lastStatusMessage() {
    return chilkatJNI.CkSFtp_lastStatusMessage(swigCPtr, this);
  }
  ...
  public void get_UserAuthBanner(CkString str) {
    chilkatJNI.CkSFtp_get_UserAuthBanner(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String userAuthBanner() {
    return chilkatJNI.CkSFtp_userAuthBanner(swigCPtr, this);
  }

  public void put_UserAuthBanner(String newVal) {
    chilkatJNI.CkSFtp_put_UserAuthBanner(swigCPtr, this, newVal);
  }
  ...
  public boolean ContinueKeyboardAuth(String response, CkString outStr) {
    return chilkatJNI.CkSFtp_ContinueKeyboardAuth(swigCPtr, this, response, CkString.getCPtr(outStr), outStr);
  }

  public String continueKeyboardAuth(String response) {
    return chilkatJNI.CkSFtp_continueKeyboardAuth(swigCPtr, this, response);
  }

  public CkTask ContinueKeyboardAuthAsync(String response) {
    long cPtr = chilkatJNI.CkSFtp_ContinueKeyboardAuthAsync(swigCPtr, this, response);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean GetHostKeyFP(String hashAlg, boolean includeKeyType, boolean includeHashName, CkString outStr) {
    return chilkatJNI.CkSFtp_GetHostKeyFP(swigCPtr, this, hashAlg, includeKeyType, includeHashName, CkString.getCPtr(outStr), outStr);
  }

  public String getHostKeyFP(String hashAlg, boolean includeKeyType, boolean includeHashName) {
    return chilkatJNI.CkSFtp_getHostKeyFP(swigCPtr, this, hashAlg, includeKeyType, includeHashName);
  }

  public String hostKeyFP(String hashAlg, boolean includeKeyType, boolean includeHashName) {
    return chilkatJNI.CkSFtp_hostKeyFP(swigCPtr, this, hashAlg, includeKeyType, includeHashName);
  }
  ...
  public boolean StartKeyboardAuth(String login, CkString outStr) {
    return chilkatJNI.CkSFtp_StartKeyboardAuth(swigCPtr, this, login, CkString.getCPtr(outStr), outStr);
  }

  public String startKeyboardAuth(String login) {
    return chilkatJNI.CkSFtp_startKeyboardAuth(swigCPtr, this, login);
  }

  public CkTask StartKeyboardAuthAsync(String login) {
    long cPtr = chilkatJNI.CkSFtp_StartKeyboardAuthAsync(swigCPtr, this, login);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
