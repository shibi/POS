...
public class CkStringBuilder {
  ...
  public boolean AppendUuid(boolean lowerCase) {
    return chilkatJNI.CkStringBuilder_AppendUuid(swigCPtr, this, lowerCase);
  }
  ...
  public boolean DecodeAndAppend(String value, String encoding, String charset) {
    return chilkatJNI.CkStringBuilder_DecodeAndAppend(swigCPtr, this, value, encoding, charset);
  }
  ...
  public boolean GetHash(String algorithm, String encoding, String charset, CkString outStr) {
    return chilkatJNI.CkStringBuilder_GetHash(swigCPtr, this, algorithm, encoding, charset, CkString.getCPtr(outStr), outStr);
  }

  public String getHash(String algorithm, String encoding, String charset) {
    return chilkatJNI.CkStringBuilder_getHash(swigCPtr, this, algorithm, encoding, charset);
  }

  public String hash(String algorithm, String encoding, String charset) {
    return chilkatJNI.CkStringBuilder_hash(swigCPtr, this, algorithm, encoding, charset);
  }
  ...
  public boolean GetRange(int startIndex, int numChars, boolean removeFlag, CkString outStr) {
    return chilkatJNI.CkStringBuilder_GetRange(swigCPtr, this, startIndex, numChars, removeFlag, CkString.getCPtr(outStr), outStr);
  }

  public String getRange(int startIndex, int numChars, boolean removeFlag) {
    return chilkatJNI.CkStringBuilder_getRange(swigCPtr, this, startIndex, numChars, removeFlag);
  }

  public String range(int startIndex, int numChars, boolean removeFlag) {
    return chilkatJNI.CkStringBuilder_range(swigCPtr, this, startIndex, numChars, removeFlag);
  }
  ...
  public boolean RemoveAccents() {
    return chilkatJNI.CkStringBuilder_RemoveAccents(swigCPtr, this);
  }
  ...
  public boolean RemoveCharsAt(int startIndex, int numChars) {
    return chilkatJNI.CkStringBuilder_RemoveCharsAt(swigCPtr, this, startIndex, numChars);
  }
  ...
  public boolean Shorten(int numChars) {
    return chilkatJNI.CkStringBuilder_Shorten(swigCPtr, this, numChars);
  }
