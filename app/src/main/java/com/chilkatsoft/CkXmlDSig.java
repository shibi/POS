...
public class CkXmlDSig {
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkXmlDSig_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkXmlDSig_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkXmlDSig_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public boolean AddEncapsulatedTimeStamp(CkJsonObject json, CkStringBuilder sbOut) {
    return chilkatJNI.CkXmlDSig_AddEncapsulatedTimeStamp(swigCPtr, this, CkJsonObject.getCPtr(json), json, CkStringBuilder.getCPtr(sbOut), sbOut);
  }
  ...
  public boolean HasEncapsulatedTimeStamp() {
    return chilkatJNI.CkXmlDSig_HasEncapsulatedTimeStamp(swigCPtr, this);
  }
  ...
  public void SetHttpObj(CkHttp http) {
    chilkatJNI.CkXmlDSig_SetHttpObj(swigCPtr, this, CkHttp.getCPtr(http), http);
  }
