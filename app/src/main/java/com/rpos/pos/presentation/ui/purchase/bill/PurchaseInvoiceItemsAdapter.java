...
public class PurchaseInvoiceItemsAdapter extends RecyclerView.Adapter<PurchaseInvoiceItemsAdapter.InvoiceItemViewHolder>{

    private List<PurchaseInvoiceItemHistory> invoiceItemsList;

    public PurchaseInvoiceItemsAdapter(List<PurchaseInvoiceItemHistory> invoiceItemsList) {
    ...
    public void onBindViewHolder(@NonNull InvoiceItemViewHolder holder, int position) {
        try {
            ...
            PurchaseInvoiceItemHistory invoiceItemData = invoiceItemsList.get(position);
