...
public class ShiftWisePurchaseReportAdapter extends RecyclerView.Adapter<ShiftWisePurchaseReportAdapter.PurchaseReportViewHolder> implements Filterable {
    ...
    public ShiftWisePurchaseReportAdapter(Context context, List<PurchaseInvoiceEntity> invoiceEntityList) {
    ...
    public static class PurchaseReportViewHolder extends RecyclerView.ViewHolder{

        private AppCompatTextView tv_custName, tv_date,tv_grosstotal, tv_netTotal,tv_mop,tv_id,tv_tax;

        public PurchaseReportViewHolder(@NonNull View itemView) {
            super(itemView);
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null) {
                ...
                if(filterString==null || filterString.isEmpty()){
                    ...
                    int shiftId = Integer.parseInt(filterString);

                    for (PurchaseInvoiceEntity invoice: invoiceEntityList){
                        if(invoice.getShiftId() == shiftId){
