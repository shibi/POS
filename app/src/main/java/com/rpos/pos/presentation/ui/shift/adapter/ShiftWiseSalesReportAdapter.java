...
public class ShiftWiseSalesReportAdapter extends RecyclerView.Adapter<ShiftWiseSalesReportAdapter.SalesReportViewHolder> implements Filterable {
    ...
    public ShiftWiseSalesReportAdapter(Context context, List<InvoiceEntity> invoiceEntityList) {
